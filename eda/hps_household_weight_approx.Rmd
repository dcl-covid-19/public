---
title: "Test household weight approximation for Household Pulse Survey"
author: "Bill Behrman" 
date: "`r Sys.Date()`"
output: 
  github_document:
...
For the U.S. and each state, we will look at the relative difference of the population estimates each week with the median of the estimates for all weeks.
...
The adult population estimates for the U.S. and each state are the same for all weeks, as expected.
...
The child population estimates for the U.S. and each state have a very wide variation  between weeks, ranging from `r round(100 * min(v$rel_diff_0_17))`% below the median to `r round(100 * max(v$rel_diff_0_17))`% above the median.
